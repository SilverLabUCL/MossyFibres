...
function [whisk_angle_filt,whisk_set_point,whisk_amp,whisk_phase,whisk_angle_bp] = get_whisking_variables( dlc_whisk_angle, fs )
    ...
    whisk_angle_filt = rad2deg(whisk_angle_filt);
